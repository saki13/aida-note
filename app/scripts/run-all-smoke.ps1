...
$scripts = @("ui-smoke","multitab-smoke","wysiwyg-smoke","mermaid-smoke","format-smoke","search-smoke","wrap-smoke","compare-smoke","theme-smoke","recent-smoke","draft-smoke","ai-smoke","ai-mermaid-smoke","opt3-bg-smoke","opt1-brief-smoke")
$results = @()
