...
| 状态 | 已关闭（cargo check ✅ 11.84s；vue-tsc 0 错误；opt5-brief-smoke 13/13 ✅ 含真实位置断言 pos=(948,84) rightGap=12；第二版补 Teleport 挂 body + 单实例主窗口 unminimize/set_focus；真实多开合并行为列 PO 本机验证） |
