...
- [x] P0 UI-2：交互设计（所见即所得编辑交互、AI 面板交互、对比视图交互）（已完成 2026-08-21，SIS-UI-2，Sprint 2；commit 5658ab8）
- [x] P1 UI-3：视觉设计（配色 / 明暗主题 / 图标）（已完成 2026-08-21，SIS-UI-3，Sprint 2；commit 5658ab8）
...
- [x] P1 FUNC-9：主题切换（明 / 暗 + 多套配色）（已完成 2026-08-22，SIS-FUNC-9，Sprint 4；commit 7c9334b）
- [x] P1 FUNC-10：自动保存 / 崩溃恢复草稿（临时目录存储，退出/恢复后清理、不留碎片）（已完成 2026-08-22，SIS-FUNC-10，Sprint 4；commit 54a048f）
- [x] P1 FUNC-11：打开最近文件列表（已完成 2026-08-22，SIS-FUNC-11，Sprint 4；commit 757f0fa）
